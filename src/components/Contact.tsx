    ...
    <>
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {/* Email Card - Opens Form */}
          <button
            onClick={() => setIsFormOpen(true)}
            className="group bg-[#141b2d] border border-[#c9a84c]/10 rounded-xl p-5 hover:border-[#c9a84c]/40 transition-all duration-300 hover:shadow-[0_0_30px_rgba(201,168,76,0.05)] block w-full text-left cursor-pointer"
          >
